...
(function(){try{
 ...
 const sources={
  ...
  community:{name:names.community,url:'/Affiliate_Lab/guides/community-traffic/',pace:'Работает через доверие',desc:'Подходит, когда тематика сообщества совпадает с интересом взрослой аудитории к игровому предложению.',first:'Выбрать подходящее сообщество, дать один понятный повод перейти и считать путь от клика до FTD.'},
  social:{name:names.social,url:'/Affiliate_Lab/guides/social-traffic/',pace:'Нужна регулярность',desc:'Подходит для привлечения игроков через короткие публикации и ролики в холодной ленте.',first:'Выбрать один формат, выпустить 10–20 сопоставимых публикаций и считать переходы, регистрации и FTD.'},
