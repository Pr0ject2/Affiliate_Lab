(function(){try{
 ...
 ].map(([title,desc,aliases])=>({title,url:'/top_zanosi/glossary/?q='+encodeURIComponent(title),section:'Словарь',desc,aliases}));


 const suggestionIndex=[{"title":"YouTube: пошаговый план запуска","url":"/top_zanosi/traffic/sources/youtube/","section":"Источники трафика","desc":"Длинные видео и Shorts: тестовая серия, отдельные метки и решение по воронке.","aliases":"youtube ютуб shorts видео ролики запуск план"},{"title":"VK Видео и Клипы: пошаговый план","url":"/top_zanosi/traffic/sources/vk-video/","section":"Источники трафика","desc":"Как подготовить сообщество, разделить форматы и измерить переходы после просмотра.","aliases":"vk вк видео клипы сообщество запуск план"},{"title":"Telegram: пошаговый план запуска","url":"/top_zanosi/traffic/sources/telegram/","section":"Источники трафика","desc":"Канал, стартовые материалы, источники подписчиков и отдельные ссылки для каждого источника.","aliases":"telegram телеграм канал размещения посевы запуск план"},{"title":"Контентный сайт: пошаговый план запуска","url":"/top_zanosi/traffic/sources/content-site/","section":"Источники трафика","desc":"Первый тематический раздел, Search Console, запросы, показы и клики.","aliases":"контентный сайт seo поиск блог search console запуск план"},{"title":"Основы партнёрского маркетинга","url":"/top_zanosi/basics/","section":"Раздел","desc":"Offer, FTD, GEO, воронка и базовая механика.","aliases":"основы база beginner basics affiliate beginner партнерка Offer ftd"},{"title":"Экономика партнёрских программ","url":"/top_zanosi/economics/","section":"Раздел","desc":"RevShare, CPA, GGR, NGR и логика выплат.","aliases":"экономика деньги выплаты revshare cpa ggr ngr revenue share"},{"title":"Аналитика и трекинг","url":"/top_zanosi/analytics/","section":"Раздел","desc":"Метки, статистика, Tracker, Cohort и сравнение источников.","aliases":"аналитика statistics tracking трекинг dashboard кабинет метрики tracker"},{"title":"Источники трафика","url":"/top_zanosi/traffic/","section":"Раздел","desc":"Поиск, видео, сообщества, соцсети, реклама, стримы и свои сайты.","aliases":"traffic трафик seo search youtube video telegram vk social ads stream источники"},{"title":"Практика вебмастера","url":"/top_zanosi/practice/","section":"Раздел","desc":"Подготовка запуска, первый тест, менеджер и разбор результата.","aliases":"практика запуск тест checklist менеджер first ftd"},{"title":"Словарь","url":"/top_zanosi/glossary/","section":"Справочник","desc":"Короткие определения терминов и английские эквиваленты.","aliases":"словарь glossary термины definitions термин"},{"title":"Инструменты","url":"/top_zanosi/tools/","section":"Справочник","desc":"Калькуляторы для воронки, теста и RevShare.","aliases":"tools инструменты калькуляторы calculator расчеты расчёт"},{"title":"Рабочий журнал","url":"/top_zanosi/notes/","section":"Для работы","desc":"Запуски, метки, показатели и выводы по тестам.","aliases":"тесты записи журнал результаты запуск"},{"title":"Мессенджеры и сообщества: как оценивать доверительный трафик","url":"/top_zanosi/guides/community-traffic/","section":"Трафик","desc":"Почему подписчики не равны качеству трафика и как сравнивать размещения по отдельным меткам.","aliases":"сообщества мессенджеры telegram телеграм канал чат community messenger доверие аудитория"},{"title":"Социальные сети: как разбирать органический трафик из ленты","url":"/top_zanosi/guides/social-traffic/","section":"Трафик","desc":"Как считать путь из холодной ленты до ссылки и не делать вывод по одному удачному посту.","aliases":"соцсети social media vk instagram tiktok лента органика реклама"},{"title":"Платный трафик: как задать тест до покупки кликов","url":"/top_zanosi/guides/paid-traffic/","section":"Трафик","desc":"Лимит расходов, учёт, структура теста и критерий остановки до первого потраченного рубля.","aliases":"платный трафик paid ads cpc cpl реклама google meta tiktok бюджет"},{"title":"Стримы и прямые эфиры: как считать трафик от живой аудитории","url":"/top_zanosi/guides/stream-traffic/","section":"Трафик","desc":"Онлайн, переходы, отдельные метки по эфирам и влияние доверия к ведущему.","aliases":"стрим stream streaming twitch youtube live эфир зрители онлайн"},{"title":"Сайты и контентные проекты: как строить источник на своей площадке","url":"/top_zanosi/guides/content-sites/","section":"Трафик","desc":"Как собрать первую тему, связать материалы и измерять собственный сайт как долгосрочный актив.","aliases":"сайт website content seo блог контент проект own media"},{"title":"Как выбрать партнёрскую программу","url":"/top_zanosi/guides/choose-program/","section":"Практика","desc":"Программа выбирается не по одной ставке: важны правила трафика, трекинг, выплаты, продукт и поддержка.","aliases":"выбор партнерской программы ставка условия трекинг выплаты менеджер качество"},{"title":"Партнёрский кабинет: как читать отчёт по кликам, регистрациям и FTD","url":"/top_zanosi/guides/partner-dashboard/","section":"Аналитика","desc":"Как найти в кабинете период, клики, регистрации, FTD, статусы и разбивки.","aliases":"партнерский кабинет статистика клики регистрации FTD доход отчет"},{"title":"Когда нужна Landing page","url":"/top_zanosi/guides/landing-page/","section":"Практика","desc":"Когда собственная страница помогает воронке, а когда только добавляет лишний шаг.","aliases":"Landing page лендинг прелендинг переход конверсия сайт"},{"title":"Нужен ли Tracker новичку","url":"/top_zanosi/guides/tracker-for-beginner/","section":"Аналитика","desc":"Когда отдельный Tracker действительно нужен и в каких случаях на старте можно обойтись без него.","aliases":"Tracker Postback серверный трекинг метки конверсия новичок"},{"title":"Как работать с менеджером партнёрской программы","url":"/top_zanosi/guides/affiliate-manager/","section":"Практика","desc":"Какие вопросы задавать до запуска и какую информацию давать, если статистика выглядит странно.","aliases":"менеджер партнерской программы вопросы ставка правила трафика спор статистика"},{"title":"Что значит качество трафика","url":"/top_zanosi/guides/traffic-quality/","section":"Аналитика","desc":"Качество трафика видно по прохождению воронки и дальнейшей активности аудитории.","aliases":"качество трафика конверсия Cohort отклонения повторные депозиты"},{"title":"Что проверить перед первым запуском","url":"/top_zanosi/guides/launch-checklist/","section":"Практика","desc":"Короткая проверка ссылки, учёта кликов, мобильной версии и лимита теста до первого реального трафика.","aliases":"первый запуск чеклист ссылка мобильная версия метки тест бюджет"},{"title":"Поисковый трафик: как начать и что считать","url":"/top_zanosi/guides/search-traffic/","section":"Трафик","desc":"Почему поиск не даёт быстрый результат, как выбрать тему, получить первые результаты и считать страницы отдельно.","aliases":"поисковый трафик запрос намерение страница органика поиск"},{"title":"Видео и короткие ролики: как измерять трафик, а не просмотры","url":"/top_zanosi/guides/video-traffic/","section":"Трафик","desc":"Как отделить просмотры от переходов и сравнивать ролики по реальной воронке.","aliases":"видео трафик просмотры переходы регистрации FTD канал"},{"title":"Как устроен Affiliate Marketing","url":"/top_zanosi/guides/affiliate-marketing/","section":"Основы","desc":"Кто участвует в партнёрской схеме, где появляется трекинг и в какой момент возникает выплата.","aliases":"Affiliate Marketing партнерский маркетинг рекламодатель вебмастер publisher advertiser партнерская программа комиссия"},{"title":"Что такое Offer и что проверять до запуска","url":"/top_zanosi/guides/offer/","section":"Основы","desc":"До запуска Offer проверь действие, страну, ограничения и правила учёта конверсий.","aliases":"Offer offer geo ставка cpa revshare ограничения источники трафика условия Attribution"},{"title":"Метки, Click ID и Postback: как не путать трекинг","url":"/top_zanosi/guides/tracking/","section":"Аналитика","desc":"Метки источника, Click ID и Postback решают разные задачи. Здесь они собраны в одну схему.","aliases":"tracking трекинг subid click id postback s2s utm метки Attribution источник кампания"},{"title":"GGR и NGR: откуда берётся расчётная база","url":"/top_zanosi/guides/ggr-ngr/","section":"Экономика","desc":"GGR и NGR часто стоят рядом с RevShare, но означают разные уровни расчёта дохода.","aliases":"ggr ngr gross gaming revenue net gaming revenue ставки выигрыши бонусы комиссии revshare экономика"},{"title":"Метрики трафика: как считать конверсии, стоимость FTD и доход","url":"/top_zanosi/guides/metrics/","section":"Аналитика","desc":"Формулы для конверсий, стоимости FTD и сравнения сопоставимых источников.","aliases":"метрики kpi ctr cr conversion rate epc clicks регистрации ftd cpa стоимость привлечения Cohort"},{"title":"GEO Offer: почему одна связка по-разному работает в разных странах","url":"/top_zanosi/guides/geo/","section":"Основы","desc":"GEO определяет язык, платежи, правила рекламы и доступность продукта.","aliases":"geo гео страна локализация язык валюта платежи регулирование мобильный трафик affiliate igaming"},{"title":"FTD: что считается FTD","url":"/top_zanosi/guides/ftd/","section":"Основы","desc":"Разница между регистрацией и FTD, плюс две конверсии для первого разбора.","aliases":"ftd FTD регистрация конверсия основы"},{"title":"Как устроен RevShare в гемблинге","url":"/top_zanosi/guides/revshare/","section":"Экономика","desc":"От GGR и NGR до отрицательного баланса и длинной жизни игрока.","aliases":"revshare ggr ngr negative carry доход экономика"},{"title":"CPA или RevShare: как сравнивать модели выплат","url":"/top_zanosi/guides/cpa-vs-revshare/","section":"Экономика","desc":"Какие цифры нужны, чтобы сравнение не сводилось к ставке в рекламном баннере.","aliases":"cpa revshare сравнение выплаты экономика"},{"title":"Статистика партнёрской программы: 5 показателей для первого разбора","url":"/top_zanosi/guides/statistics/","section":"Аналитика","desc":"Пять исходных цифр, с которых достаточно начать разбор партнёрской статистики.","aliases":"статистика клики регистрации ftd Cohort доход аналитика"},{"title":"Органический и условно бесплатный трафик","url":"/top_zanosi/guides/free-traffic/","section":"Трафик","desc":"Поисковый трафик, видео, сообщества и собственные инструменты: плюсы, минусы и цена времени.","aliases":"трафик seo youtube видео сообщества органика убт"},{"title":"Первый FTD: как провести тест и не запутаться в данных","url":"/top_zanosi/guides/first-ftd/","section":"Практика","desc":"Простой порядок действий от выбора источника до разбора первой конверсии.","aliases":"первый ftd тест источник Offer subid практика"},{"title":"Как выбрать источник трафика: от бюджета и времени к первому тесту","url":"/top_zanosi/guides/choose-traffic-source/","section":"Трафик","desc":"Выбор канала по бюджету, контенту, своей аудитории и скорости обратной связи.","aliases":"как выбрать источник трафика выбор канала бюджет время контент аудитория быстрый результат seo video social paid"},{"title":"Клики есть, регистраций нет: что проверить по порядку","url":"/top_zanosi/guides/clicks-no-registrations/","section":"Аналитика","desc":"Пошаговая проверка участка между кликом и регистрацией.","aliases":"клики есть регистраций нет нет регистраций clicks no registrations лендинг гео воронка"},{"title":"Регистрации есть, FTD нет: где искать причину","url":"/top_zanosi/guides/registrations-no-ftd/","section":"Аналитика","desc":"FTD, путь после регистрации, платежи, задержка и качество аудитории.","aliases":"регистрации есть депозитов нет нет ftd registration no deposit FTD"},{"title":"Статистика не сходится: как сверить клики и конверсии между системами","url":"/top_zanosi/guides/statistics-mismatch/","section":"Аналитика","desc":"Период, часовой пояс, Click ID, SubID и postback.","aliases":"статистика не сходится расхождение Tracker кабинет click id subid postback mismatch"}];
...
}catch(e){console.error('Affiliate Lab module 1 error',e);}})();
;

(function(){try{
 var path=location.pathname, search=location.search, key='home';
 if(path.indexOf('/top_zanosi/traffic/')===0) key='traffic';
 else if(path.indexOf('/top_zanosi/glossary/')===0) key='glossary';
 else if(path.indexOf('/top_zanosi/diagnostics/')===0) key='diagnostics';
 else if(path.indexOf('/top_zanosi/tools/')===0) key='tools';
 else if(path.indexOf('/top_zanosi/start/')===0) key='start';
 else if(path.indexOf('/top_zanosi/notes/')===0) key='notes';
 else if(path.indexOf('/top_zanosi/path/')===0) key='notes';
 else if(path.indexOf('/top_zanosi/help/')===0) key='help';
 else if(path.indexOf('/top_zanosi/about/')===0) key='about';
 else if(path.indexOf('/top_zanosi/basics/')===0) key='basics';
 else if(path.indexOf('/top_zanosi/economics/')===0) key='economics';
 else if(path.indexOf('/top_zanosi/analytics/')===0) key='analytics';
 else if(path.indexOf('/top_zanosi/traffic/')===0) key='traffic';
 else if(path.indexOf('/top_zanosi/practice/')===0) key='practice';
 else if(path.indexOf('/top_zanosi/guides/')===0){
...
}catch(e){console.error('Affiliate Lab module 2 error',e);}})();
...
(function(){try{
  ...
  syncHintState();
}catch(e){console.error('Affiliate Lab module 3 error',e);}})();
...
(function(){try{
 ...
 const sources={
  search:{name:names.search,url:'/top_zanosi/guides/search-traffic/',pace:'Медленный старт',desc:'Подходит, если готов отвечать на уже существующие вопросы и ждать, пока страницы начнут получать показы.',first:'Выбрать одну узкую тему и собрать 5–10 реальных вопросов пользователей.'},
  video:{name:names.video,url:'/top_zanosi/guides/video-traffic/',pace:'Нужна серия попыток',desc:'Первые результаты обычно появляются быстрее, чем в поиске, но один ролик ничего не доказывает.',first:'Сделать 5–10 роликов одного формата и дать каждому отдельную метку.'},
  community:{name:names.community,url:'/top_zanosi/guides/community-traffic/',pace:'Работает через доверие',desc:'Сильный вариант, если люди уже читают канал или группу и воспринимают рекомендации автора.',first:'Разделить каналы и размещения метками, затем сравнивать их по одной воронке.'},
  social:{name:names.social,url:'/top_zanosi/guides/social-traffic/',pace:'Нужна регулярность',desc:'Подходит для проверки разных подач в ленте, но требует серии публикаций, а не одного удачного поста.',first:'Выбрать один формат и выпустить 10–20 сопоставимых публикаций.'},
  ads:{name:names.ads,url:'/top_zanosi/guides/paid-traffic/',pace:'Быстрые данные, платный риск',desc:'Даёт быструю обратную связь, если площадка разрешает такой трафик и расход ограничен заранее.',first:'Задать бюджет, ожидаемый объём кликов и точку остановки до запуска.'},
  stream:{name:names.stream,url:'/top_zanosi/guides/stream-traffic/',pace:'Сильно зависит от ведущего',desc:'Подходит тем, кто готов работать вживую и может удерживать внимание, а не просто вывести ссылку на экран.',first:'Провести 3–5 эфиров и отдельно записать онлайн, клики и дальнейшие действия.'},
  site:{name:names.site,url:'/top_zanosi/guides/content-sites/',pace:'Проект на месяцы',desc:'Даёт контроль над материалами, ссылками и аналитикой, но не приносит быстрый поток сам по себе.',first:'Собрать один связанный раздел из 3–5 материалов вокруг одной задачи.'}
 };
 ...
 if(memory&&prev&&sources[prev.key]){memory.hidden=false;memory.innerHTML=`Последний выбор: <b>${sources[prev.key].name}</b>, <a href="/top_zanosi/tools/">использовать в инструментах</a>`;if(startButton)startButton.textContent='Подобрать другой источник'}
 ...
 function finish(){
  ...
  if(conflict){results.innerHTML='<span class="wizard-result-label">Сначала стоит изменить одно условие</span><div class="wizard-conflict"><b>Сейчас не хватает точки входа</b><p>Без бюджета, готовности регулярно делать контент или уже существующей аудитории нельзя выбрать рабочий источник только настройками. Сначала реши, что готов добавить: время на контент, бюджет на закупку или работу над собственной аудиторией.</p><a href="/top_zanosi/traffic/compare/">Сравнить источники</a></div><button type="button" class="wizard-restart">Пройти ещё раз</button>'}
  else{
   ...
   results.innerHTML='<span class="wizard-result-label">Сначала посмотри эти направления</span><div class="wizard-results-grid">'+top.map(s=>`<a class="wizard-result" href="${s.url}"><small>${s.pace}</small><b>${s.name}</b><p>${s.desc}</p><div class="wizard-why"><strong>Почему:</strong>${reasons(s.key).map(x=>`<span>${x}</span>`).join('')}</div><div class="wizard-plan"><strong>Первый рабочий шаг</strong><span>${s.first}</span></div><em>Открыть разбор</em></a>`).join('')+'</div><div class="wizard-continuation"><span>Выбор сохранён в этом браузере.</span><a href="/top_zanosi/tools/">Посчитать первый тест</a><a href="/top_zanosi/traffic/compare/">Сравнить его с другим</a></div><button type="button" class="wizard-restart">Пройти ещё раз</button>';
  }
...
}catch(e){console.error('Affiliate Lab module 4 error',e);}})();
...
}catch(e){console.error('Affiliate Lab module 5 error',e);}})();
...
(function(){try{
 ...
 if(article && location.pathname.startsWith('/top_zanosi/guides/')){
...
}catch(e){console.error('Affiliate Lab module 6 error',e);}})();
...
(function(){try{
 ...
 if(article){
  ...
  if(notesLink){notesLink.href='/top_zanosi/notes/?from='+encodeURIComponent(location.pathname);notesLink.textContent='В рабочий журнал'}
 }
 ...
 const context=from.startsWith('/top_zanosi/')?{url:from,title:known?.title||'Материал Affiliate Lab'}:null;
 ...
 render();
}catch(e){console.error('Affiliate Lab notes error',e);}})();

/* v32 - three core tools + remembered source */
(function(){try{
 const KEY='al-selected-source-v1';
 const presets={
  search:{name:'Поисковый трафик',reg:11,ftd:18,cpc:12,hint:'Стартовые поля здесь только пример сценария. Для поиска особенно важны запрос, страница и страна; быстрый результат не предполагается.'},
  video:{name:'Видео и короткие ролики',reg:6.5,ftd:11,cpc:9,hint:'Стартовые поля - пример. У видео результат сильнее зависит от темы, подачи и того, насколько зритель готов перейти из просмотра к действию.'},
  community:{name:'Сообщества и мессенджеры',reg:8.5,ftd:15,cpc:4,hint:'Стартовые поля - пример. У чужого размещения и своей аудитории цифры могут сильно отличаться.'},
  ads:{name:'Платная реклама',reg:7.5,ftd:12,cpc:22,hint:'Стартовые поля - пример, а не рыночная норма. Сегмент, креатив и площадка могут заметно изменить результат.'},
  stream:{name:'Стримы и прямые эфиры',reg:4.8,ftd:9,cpc:0,hint:'Стартовые поля - пример. У эфиров большую роль играет доверие к ведущему и качество аудитории.'},
  social:{name:'Социальные сети',reg:null,ftd:null,cpc:0,hint:'Для социальных сетей сайт не подставляет универсальные конверсии: холодная лента, собственный профиль и прогретая аудитория слишком различаются. Внеси свои данные.'},
  site:{name:'Свой сайт и контентный проект',reg:null,ftd:null,cpc:0,hint:'Для собственного сайта нет универсальной стартовой конверсии. Она зависит от запроса, страницы и состава аудитории. Внеси свои данные.'}
 };
...
}catch(e){console.error('Affiliate Lab module 7 error',e);}})();
...
}catch(e){console.error('Affiliate Lab module 8 error',e);}})();
...
}catch(e){console.error('Affiliate Lab module 9 error',e);}})();
...
(function(){try{
 ...
 const pathConfig={
  beginner:{
   ...
   cards:[
    ['/top_zanosi/guides/affiliate-marketing/','Как устроена вся цепочка?','Кто приводит пользователей, что фиксирует партнёрская программа и за какое действие появляется выплата.'],
    ['/top_zanosi/guides/choose-traffic-source/','Как выбрать один источник?','Отсеять неподходящие варианты по бюджету, контенту, аудитории и скорости обратной связи.'],
    ['/top_zanosi/guides/launch-checklist/','Что проверить до запуска?','Ссылка, GEO, мобильный путь, метки, лимит теста и точка остановки.'],
    ['/top_zanosi/guides/statistics/','Как разобрать первые цифры?','Сравнить клики, регистрации, FTD и доход за один период.']
   ]
  },
  pro:{
   ...
   cards:[
    ['/top_zanosi/diagnostics/','Понять, где проседает трафик','Клики есть, но дальше люди теряются? Начни с конкретного участка воронки.'],
    ['/top_zanosi/traffic/compare/','Сравнить два источника','Сопоставь требования, обратную связь, аналитику и то, что остаётся после остановки работы.'],
    ['/top_zanosi/guides/revshare/','Разобрать экономику RevShare','Понять расчётную базу, отрицательный баланс и почему количество депозитов ещё не равно доходу.'],
    ['/top_zanosi/guides/tracking/','Проверить учёт результата','Разобрать метки, Click ID и передачу конверсий между системами.']
   ]
  }
 };
 const proNext={
  '/top_zanosi/guides/affiliate-marketing/':['/top_zanosi/guides/offer/','Проверить условия конкретного предложения'],
  '/top_zanosi/guides/ftd/':['/top_zanosi/guides/statistics/','Разобрать статистику по этапам'],
  '/top_zanosi/guides/statistics/':['/top_zanosi/diagnostics/','Диагностировать свой трафик'],
  '/top_zanosi/guides/first-ftd/':['/top_zanosi/guides/partner-dashboard/','Сверить первый тест с кабинетом'],
  '/top_zanosi/guides/revshare/':['/top_zanosi/guides/ggr-ngr/','Разобрать GGR и NGR'],
  '/top_zanosi/guides/tracking/':['/top_zanosi/guides/partner-dashboard/','Сверить это с партнёрским кабинетом'],
  '/top_zanosi/guides/search-traffic/':['/top_zanosi/guides/landing-page/','Проверить путь после поискового клика'],
  '/top_zanosi/guides/video-traffic/':['/top_zanosi/guides/tracking/','Разметить ролики и ссылки'],
  '/top_zanosi/guides/paid-traffic/':['/top_zanosi/guides/launch-checklist/','Зафиксировать лимит и проверку запуска'],
  '/top_zanosi/guides/launch-checklist/':['/top_zanosi/guides/first-ftd/','Провести первый измеримый тест'],
  '/top_zanosi/guides/metrics/':['/top_zanosi/guides/traffic-quality/','Оценить качество трафика, а не только объём']
 };
...
}catch(e){console.error('Affiliate Lab module 10 error',e);}})();
...
}catch(e){console.error('Affiliate Lab module 11 error',e);}})();
...
(function(){try{
 ...
 function detect(q){q=n(q);if(!q)return null;
  ...
  return null}
 function render(){const hit=detect(input.value);box.hidden=!hit;if(!hit)return;box.innerHTML=`<span>Нашёл разбор по этому запросу</span><b>${hit[1]}</b><p>Можно сразу открыть пошаговую диагностику вместо просмотра общего списка статей.</p><a href="/top_zanosi/diagnostics/?problem=${hit[0]}">${hit[2]}</a>`}
 input.addEventListener('input',render);render();
}catch(e){console.error('Affiliate Lab module 12 error',e);}})();
...
}catch(e){console.error('Affiliate Lab module 13 error',e);}})();
...
(function(){try{
 ...
 const sbox=document.getElementById('pathSourceState');if(sbox){if(source&&source.key){sbox.innerHTML=`<b class="path-source-name">${sourceNames[source.key]||source.name||source.key}</b><p>Этот источник сохранён для расчётов и заметок.</p><div class="path-source-actions"><a href="/top_zanosi/tools/?source=${source.key}">Открыть инструменты</a><a href="/top_zanosi/traffic/">Выбрать другой</a></div>`}else{sbox.innerHTML='<p>Источник пока не выбран. Библиотека работает и без этого.</p><div class="path-source-actions"><a href="/top_zanosi/traffic/">Выбрать источник</a><a href="/top_zanosi/traffic/compare/">Сравнить варианты</a></div>'}}
 const cbox=document.getElementById('pathContinueState');if(cbox){const last=recent[0];if(last){const st=states[last.url]||{},pr=st.progress||0,pct=Math.max(0,Math.min(100,Math.round(pr*100)));const href=pr>.05&&pr<.82?last.url+'?continue=1':last.url;cbox.innerHTML=`<h2>${last.title}</h2><p>${pr>=.78?'Материал почти дочитан. Можно вернуться к нему или продолжить по рекомендациям в конце.':pr>.05?'Вернуться к месту, где остановились.':'Недавно открытый материал.'}</p><div class="path-progress"><i style="width:${pct}%"></i></div><small>Прогресс: около ${pct}%</small><div class="path-continue-actions"><a href="${href}">${pr>.05&&pr<.82?'Продолжить чтение':'Открыть материал'}</a><a href="/top_zanosi/notes/">История чтения</a></div>`}else{cbox.innerHTML='<p>История чтения пока пустая. Начни с любого раздела - здесь появится удобное продолжение.</p><div class="path-continue-actions"><a href="/top_zanosi/guides/">Открыть материалы</a></div>'}}
 const bbox=document.getElementById('pathSavedState');if(bbox){bbox.innerHTML=`<b class="path-source-name">${book.length}</b><p>${book.length===1?'материал сохранён в закладках':'материалов сохранено в закладках'}.</p><div class="path-source-actions"><a href="/top_zanosi/notes/">Открыть закладки</a></div>`}
}catch(e){console.error('Affiliate Lab module 14 error',e);}})();
...
(function(){try{
 ...
 const configs={
  '/top_zanosi/basics/':{
   beginner:['С чего начать в этом разделе','Сначала разберись в общей схеме партнёрской программы.','/top_zanosi/guides/affiliate-marketing/','Открыть общую схему'],
   pro:['Если база уже знакома','Быстрее всего полезно проверить условия конкретной программы и правила учёта результата.','/top_zanosi/guides/offer/','Проверить условия программы']
  },
  '/top_zanosi/economics/':{
   beginner:['С чего начать в этом разделе','Сначала пойми, откуда вообще берётся выплата по процентной модели.','/top_zanosi/guides/revshare/','Разобрать RevShare'],
   pro:['Рабочая задача','Сравнивай не процент в рекламе, а реальную расчётную базу и качество трафика.','/top_zanosi/guides/ggr-ngr/','Разобрать GGR и NGR']
  },
  '/top_zanosi/analytics/':{
   beginner:['С чего начать в этом разделе','Начни с кабинета: клики, регистрации, FTD и доход.','/top_zanosi/guides/partner-dashboard/','Как читать кабинет'],
   pro:['Рабочая задача','Если трафик уже идёт, проверь разметку источников и качество данных до выводов по цифрам.','/top_zanosi/guides/tracking/','Проверить трекинг']
  },
  '/top_zanosi/practice/':{
   beginner:['Перед первым запуском','Пройди короткую проверку ссылки, источника и лимита теста.','/top_zanosi/guides/launch-checklist/','Открыть проверку'],
   pro:['Если трафик уже запущен','Не перечитывай базу: начни с конкретного участка, где просел результат.','/top_zanosi/diagnostics/','Открыть диагностику']
  },
  '/top_zanosi/traffic/':{
   ...
   pro:['Если уже есть рабочий источник','Сравни его с альтернативой по обратной связи, аналитике и ресурсу на запуск.','/top_zanosi/traffic/compare/','Сравнить источники']
  },
  '/top_zanosi/tools/':{
  ...
  '/top_zanosi/diagnostics/':{
   ...
   pro:['Если цифры уже есть','После быстрой диагностики можно сразу проверить фактические конверсии в инструментах.','/top_zanosi/tools/#diagnose-result','Разобрать цифры']
  },
  '/top_zanosi/guides/':{
   beginner:['Порядок материалов','В режиме «Начинаю» базовые материалы показываются выше, но поиск видит всю библиотеку.','/top_zanosi/start/','Маршрут с нуля'],
   pro:['Порядок материалов','В режиме «Есть опыт» выше показываются диагностика, Tracking и разбор экономики. Поиск по-прежнему видит всё.','/top_zanosi/diagnostics/','К рабочим задачам']
  },
  '/top_zanosi/start/':{
   ...
   pro:['Базу можно пропустить','Если трафик уже идёт, полезнее сразу перейти к диагностике, сравнению или аналитике.','/top_zanosi/diagnostics/','Перейти к диагностике']
  },
  '/top_zanosi/help/':{
 ...
 render();
}catch(e){console.error('Affiliate Lab module 15 error',e);}})();
...
(function(){try{
 ...
 document.addEventListener('click',function(e){
   ...
   const affiliate=e.target.closest('.partner-next-step a,[href^="/top_zanosi/go/partner/"]');
...
}catch(e){console.error('Affiliate Lab analytics error',e);}})();
...
(function(){try{
 ...
 function classify(target){
   ...
   if(target.closest('[href^="/top_zanosi/go/partner/"],.partner-next-step'))return 'affiliate';
...
}catch(e){console.error('Affiliate Lab first-action analytics error',e);}})();
