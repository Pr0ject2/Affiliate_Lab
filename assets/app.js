(function(){try{
 ...
 const quickSearchSuggestions=[
  ...
  {title:'1win Partners для первого запуска',url:'/Affiliate_Lab/guides/1win-rules/',section:'Практика',desc:'Почему TrafficLab использует 1win как основной пример для новичка: RevShare, GEO, выплаты и правила запуска.',aliases:'1win правила geo гео новичок первый запуск'},
  ...
  const initReferenceUI=()=>{
    ...
    if(sidebar){
      sidebar.innerHTML=`
        ...
        <a class="ref-partner-card" href="${base}guides/1win-rules/"><b>1win Partners — старт для новичка</b><span>Основной пример TrafficLab: RevShare, GEO, выплаты и первый тест в одном понятном маршруте.</span><em>Посмотреть условия <span>→</span></em></a>`;
