(function(){try{
 ...
 const quickSearchSuggestions=[
  ...
  {title:'Партнёрская программа для первого запуска',url:'/guides/1win-rules/',section:'Практика',desc:'Рабочий пример для новичка: RevShare, GEO, выплаты и правила запуска.',aliases:'1win правила geo гео новичок первый запуск'},
...
(function(){try{
 ...
 const context=from.startsWith('/')?{url:from,title:sourceTitle||'Материал TrafficLab'}:null;
